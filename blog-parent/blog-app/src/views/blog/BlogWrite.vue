      ...
      <base-header :simple=true>
        ...
        <el-col :span="4" :offset="6">
          <div class="me-write-btn">
            ...
            <el-button v-if="this.flagId!=null" round @click="publishShow" >编辑</el-button>
            <el-button v-if="this.flagId==null" round @click="publishShow" >发布</el-button>
  ...
  export default {
    ...
    mounted() {
      ...
      if(this.$route.params.id){
        ...
        this.getArticleById(this.$route.parms.id);
